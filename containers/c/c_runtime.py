...
class DockerCRunner:
    def __init__(self):
        ...
        self.image_name = "c-runner"
        self.container_name = "c-container"
...
'''
    ...
    def run_c_program(self, c_file_path):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            try:
                ...
                try:
                    ...
                    compile_result = container.exec_run(f"gcc -o /app/program /app/{c_file_name}")
                    if compile_result.exit_code != 0:
                        print("Compilation failed:")
                        print(compile_result.output.decode())
                        return
...
def main():
    ...
    runner.run_c_program(c_file_path)
